...
const AnimatedHeading = ({
  ...
  return (
    <motion.div
      className={`w-full text-center text-${headingSize} font-PP_Mori z-0 md:z-10 box-border text-wrap font-bold overflow-hidden gap-3 flex flex-wrap justify-center items-baseline`}
